...
import DevTools from '../container/DevTool'; // 引入DevTools调试组件
...
const store =  createStore(rootReducer, compose(applyMiddleware(loggerMiddleware,thunk),DevTools.instrument()))
